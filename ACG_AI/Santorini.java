...
public class Santorini {
	...
	private myGreedyAI myGrAI;
	private myAlphaAI myAlphaAI;
	...
	public Santorini(boolean againstHuman, boolean computerisTeamA)
	{
		...
		this.myGrAI = new myGreedyAI(this.gameState);
		this.myAlphaAI = new myAlphaAI(this.gameState);
	}
		...
		while (!isGameOverWin)
		{
			...
			if (gameState.getIsTeamATurn()!=computerIsTeamA)
			{
				...
				if (againstHuman)
				{
						...
						inp=myAlphaAI.nextMove();
						System.out.println("AlphaBeta AI plays:"+inp);
			...
			{
				inp=myGrAI.nextMove();
				System.out.println("Greedy AI plays:"+inp);
			}
			int b=inp%10;
			inp /= 10;
			int m=inp%10;
